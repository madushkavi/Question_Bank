		...
		<div id="container">
			...
			<div id="content">	
				...
				<div id="main" >
					<h2>
					<label>1. 
					<a id="link" href="notice.php">Professional Practice</a></label><br><br>
					<label>2.
					<a id="link" href="notice.php">Bioinfomatics</a></label><br><br>
					
					<label>3. 
					<a id="link" href="Web_Technology.php?cname=web">Web Technologies</a></label><br><br>
					<label>4.
					<a id="link" href="notice.phps">Operating System</a></label><br><br>
					<label>5.
					<a id="link" href="notice.php">Software Engineering</a></label>
					</h2>
				</div>
			</div>
