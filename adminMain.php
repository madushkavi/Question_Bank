		...
		<div id="container">
			...
			<div id="content">	
				...
				<div id="main" >
					<h2>
					<label>1. </label>
					<a id="link" href="adminu.php.php"><label>Users</label></a><br><br>
					<label>2. </label>
					<a id="link" href="admin.php"><label>Questions</label></a><br><br>
					<label>3. </label>
					<a id="link" href="adminpdf.php"><label>PDF</label></a><br><br>
					<label>4. </label>
					
					<a id="link" href="departments.php?user=admin"><label>Site Home</label></a>
					</h2>
				</div>
			</div>
