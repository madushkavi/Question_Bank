		...
		<div id="container">
			...
			<div id="content">	
				<!--</div><div id="side-bar-left">
					<a id="link" href="notice.php">link</a>
				</div>-->
				<div class="locations">
					<ul>
				...
				<div id="main" >
					...
					<label><a id="link" href="notice.php">Level 1</a></label><br><br>
					
					<label><a id="link" href="courses.php">Level 2</a></label><br><br>
					
					<label><a id="link" href="notice.php">Level 3</a></label><br><br>
					
					<label><a id="link" href="notice.php">Level 4</a></label><br><br>
					</h2>
				</div>
			</div>
